...
class FoodArchive {
    companion object{
        ...
        var foodDataList = arrayListOf<FoodSaved>(
            ...
            FoodSaved(name = "בשר טחון  30% (לאחר בישול) ", calPer100gr = 250, imageID = R.drawable.beef, asUnit = false, caloriesPerUnit = 0,category =  FoodCategory.MEAT, carbPer100gr = 0 , netCarbPer100gr = 0, proteinPer100gr = 25, fatPer100gr = 15),
