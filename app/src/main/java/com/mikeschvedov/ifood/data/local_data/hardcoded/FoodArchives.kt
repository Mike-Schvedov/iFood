...
class FoodArchive {
    companion object{
        ...
        var foodDataList = arrayListOf<FoodSaved>(
            ...
            FoodSaved(name = "דג סלומון", calPer100gr =210, imageID = R.drawable.salmon, asUnit = false, caloriesPerUnit = 0,category = FoodCategory.FISH, carbPer100gr = 1 , netCarbPer100gr = 1, proteinPer100gr = 20, fatPer100gr = 14),
            //ה
            ...
            FoodSaved(name = "חזה עוף", calPer100gr =170, imageID = R.drawable.chicken_breast, asUnit = false, caloriesPerUnit = 0,category = FoodCategory.MEAT, carbPer100gr = 0 , netCarbPer100gr = 0, proteinPer100gr = 30, fatPer100gr = 4),
            ...
            FoodSaved(name = "כרוב", calPer100gr =25, imageID = R.drawable.general, asUnit = false, caloriesPerUnit = 0,category = FoodCategory.VEGETABLE, carbPer100gr = 6 , proteinPer100gr = 1, fatPer100gr = 0),
            ...
            FoodSaved(name = "מעדן GO", calPer100gr =0, imageID = R.drawable.maadango,asUnit =  true, caloriesPerUnit = 110,category = FoodCategory.DAIRY, carbPerUnit = 8, netCarbPer100gr = 8, proteinPerUnit = 20, fatPerUnit = 0),
            ...
            FoodSaved(name = "תות שדה", calPer100gr =32, imageID = R.drawable.general, asUnit = false, caloriesPerUnit = 0,category = FoodCategory.FRUIT, carbPer100gr = 8 , netCarbPer100gr = 6, proteinPer100gr = 0, fatPer100gr = 4),
        )
